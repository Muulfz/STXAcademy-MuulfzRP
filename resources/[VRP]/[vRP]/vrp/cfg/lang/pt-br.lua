vRP.lang = {
    ...
    atm = {
        ...
        deposit = {
            ...
            deposited = "~r~{1}R$~s~ depositados."
        },
        withdraw = {
            title = "Levantar",
            description = "Levantar dinheiro da sua conta",
            prompt = "Insira o montante que deseja levantar:",
            withdrawn = "~g~{1}R$ ~s~ retirados do banco.",
    ...
    business = {
        ...
        directory = {
            ...
            dprev = "> Anterior",
            dnext = "> Seguinte",
            info = "<em>Capital: </em>{1} R$<br /><em>Dono: </em>{2} {3}<br /><em>Nº registo: </em>{4}<br /><em>Nº de telefone: </em>{5}"
        },
        info = {
        ...
        addcapital = {
            ...
            added = "~r~{1}R$ ~s~adicionados ao capital do seu negocio."
        },
        launder = {
            title = "Lavagem de dinheiro",
            description = "Use o seu negócio para lavar dinheiro sujo.",
            prompt = "Montante de dinheiro sujo para lavagem (max {1} R$): ",
            laundered = "~g~{1}R$ ~s~limpo.",
            not_enough = "~r~Não tem dinheiro sujo suficiente."
        },
        open = {
            title = "Abrir negócio",
            description = "Abre o seu negócio, o investimento minimo para abrir o seu negócio é de {1} R$.",
    ...
    cityhall = {
        ...
        identity = {
            ...
            description = "Para criar uma nova identidade irá custar: {1} R$.",
    ...
    police = {
        ...
        menu = {
            ...
            fine = {
                ...
                notify_fined = "~b~Foi multado no valor de ~s~ {2} R$ por ~b~{1}.",
    ...
    home = {
        buy = {
            title = "Comprar",
            description = "Comprar esta casa, o seu preço é {1} R$.",
            bought = "~g~Comprado.",
        ...
        sell = {
            title = "Vender",
            description = "Vender a sua casa por {1} R$",
            sold = "~g~Vendida.",
        ...
        gametable = {
            ...
            bet = {
                ...
                request = "[APOSTA] Deseja apostar {1} R$ ?",
    ...
    gunshop = {
        ...
        info = "<em>Arma: </em> {1} R$<br /><em>Munições: </em> {2} R$/u<br /><br />{3}"
    },
    market = {
        title = "Loja ({1})",
    ...
    commands = {
        admin = {
            kick = {
                cmd = "expulsar",
                description = "Pode expulsar um usuario do servidor",
                reason_default = "Você foi expulso da cidade"
            },
            coords = {
                cmd = "coordenadas",
                description = "Copie a coordenada atual utilizando Crtl-A Ctrl C"
            },
            revive = {
                cmd = "reviver",
                description = "Reviva um jogador"
            },
            noclip = {
                cmd = "noclip",
                description = "Torna um jogador invisivel e inatingivél"
            },
            setMoney = {
                cmd = "setmoney",
                description = "Seta valor determinado."
            },
            create_drop = {
                cmd = "createdrop",
                description = "Cria um item drop em uma posição específica"
            },
            delete_drop = {
                cmd = "deletedrop",
                description = "Deleta um item drop pelo id"
            }
        },
        missing_arguments = "~r~Faltando argumentos"
    }
}
