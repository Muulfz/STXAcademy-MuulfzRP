...
function setter(event, setting, send_value) {
    ...
    if (event == 'parents') {
        ...
        $.post(`https://${GetParentResourceName()}/charDataParents`, JSON.stringify(array))
        ...
        $.post(`https://${GetParentResourceName()}/charDataFace`, JSON.stringify(array));
    } else if (event == 'eyes') {
        $("#eyeColorName").text(eyeColorNames[send_value]);
        $.post(`https://${GetParentResourceName()}/charDataEyeColor`, send_value);
        ...
        $.post(`https://${GetParentResourceName()}/charDataOverlay`, JSON.stringify(array));
        ...
        $.post(`https://${GetParentResourceName()}/charDataOverlayColor`, JSON.stringify(array));
        ...
        $.post(`https://${GetParentResourceName()}/charDataHair`, index);
    } else if (event == 'hairColor') {
        charDataHairColor = parseInt(send_value);

        $.post(`https://${GetParentResourceName()}/charDataHairColor`, charDataHairColor, charDataHairColorHighlight);
