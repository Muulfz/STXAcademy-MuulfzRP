...
local function tr_remove_player(tr, player)
    -- remove player from transforming
...
function vRP.removeItemTransformer(name)
    ...
    if tr then
        ...
        for k, v in pairs(players) do
            -- remove players from transforming
